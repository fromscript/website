    ...
    <ParallaxProvider>
      <section id="about"
        ...
        <div className="self-stretch flex justify-center items-center flex-col overflow-hidden h-72">
          <Parallax className="text-blue-700 text-5xl md:text-8xl font-bold font-brockmann"
                    translateX={[60, -40]}
                    easing="easeOutQuad"
                    disabled={isMobile} // Disable parallax on mobile
          >
            La technologie
          </Parallax>
          <Parallax className="text-center md:text-start text-blue-700 text-5xl md:text-8xl font-bold font-brockmann"
                    translateX={[-60, 40]}
                    easing="easeOutQuad"
                    disabled={isMobile} // Disable parallax on mobile
          >
        ...
        <div className="flex =self-stretch justify-center items-center">
          <div className="md:max-w-5xl h-auto bg-white flex flex-col md:flex-row justify-center items-center gap-10 md:gap-20 px-4 md:px-0">
            <div className="flex flex-col justify-center items-center">
              <div className="text-blue-500 text-center md:text-start text-2xl md:text-[40px] text-wrap font-bold font-brockmann leading-tight">
                Découvrez l'expertise de FromScript en développement logiciel et sécurité informatique.
              </div>
            </div>
            <div className="flex flex-col justify-center items-center text-left">
              <div className="justify-start text-center md:text-start">

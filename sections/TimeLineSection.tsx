...
const TimeLineSection: React.FC = () => {
    ...
    return (
        <ParallaxProvider>
            <div
                className="w-full py-12 h-auto bg-fond3 flex items-center gap-14 justify-center relative overflow-hidden px-10">
                <div className="self-stretch flex flex-col">
                    <Parallax translateY={[0, 100]} easing="easeOutQuad">
                        <div className="flex flex-col items-center">
                            <div className="self-stretch text-white text-base font-semibold font-brockmann">
                                À propos
                            </div>
                            <div className="self-stretch text-blue-500 text-5xl font-bold font-brockmann">
                                Pourquoi FromScript?
                            </div>

                            <div className="self-stretch flex flex-row justify-start mt-6">
                                <SectionScrollButton text='En savoir plus'
                                                     className="px-6 py-3 border-2 border-white text-white hover:bg-white hover:text-blue-500 transition duration-300 mr-4"
                                                     targetSection='about'/>
